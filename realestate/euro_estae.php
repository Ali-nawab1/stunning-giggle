...
window.location="euro_estae.php";
</script>
...
<?php 
	...
	*/
	$query = "SELECT COUNT(*) as num FROM where propertyCat='Sell' addeuro ORDER BY Id DESC";
	$total_pages = mysql_fetch_array(mysql_query($query));
	 $total_pages = $total_pages[num];
	
	/* Setup vars for query. */
	$targetpage = "euro_estae.php"; 	//your file name  (the name of this file)
	...
	/* Get data. */
	$sql = "SELECT * FROM addeuro where propertyCat='Sell' ORDER BY Id DESC  LIMIT $start, $limit";
	...
	*/
	...
	{	
		...
		//previous button
		if ($page > 1) 
			$pagination.= "<a href=\"euro_estae.php?page=$prev\">« previous</a>";
		else
		...
		{	
			for ($counter = 1; $counter <= $lastpage; $counter++)
			{
				if ($counter == $page)
					...
					$pagination.= "<a href=\"euro_estae.php?page=$counter\">$counter</a>";					
			}
		}
		elseif($lastpage > 5 + ($adjacents * 2))	//enough pages to hide some
		{
			...
			if($page < 1 + ($adjacents * 2))		
			{
				...
				$pagination.= "...";
				$pagination.= "<a href=\"euro_estae.php?page=$lpm1\">$lpm1</a>";
				$pagination.= "<a href=\"euro_estae.php?page=$lastpage\">$lastpage</a>";		
			}
			//in middle; hide some front and some back
			elseif($lastpage - ($adjacents * 2) > $page && $page > ($adjacents * 2))
			{
				$pagination.= "<a href=\"euro_estae.php?page=1\">1</a>";
				$pagination.= "<a href=\"euro_estae.php?page=2\">2</a>";
				$pagination.= "...";
		...
		//next button
		if ($page < $counter - 1) 
			$pagination.= "<a href=\"euro_estae.php?page=$next\">next »</a>";
		else
...
News                    </td>
          ...
          <tr>
            ...
            <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="22%" height="243"  valign="top"><?php include"menu.php";?></td>
                    <td width="1%">&nbsp;</td>
...
<a href="addEuro.php">
                                    ...
                                    <tr>
                                      <td colspan="4" align="left" valign="top"><img src="images/spacer.gif" alt="Spacer" width="1" height="1" />
                                        <table  width="100%" cellspacing="0" cellpadding="0" border="0" >
                                          <tr>
                                            <td width="1%" class="txtb1"></td>
                                            <td width="7%" class="txtb1"> Type</td>
											  <td width="5%" class="txtb1"> Title</td>
											  	  <td width="8%" class="txtb1">Address</td>
                                              <td width="6%" class="txtb1">  Size </td>
                                            <td width="10%" class="txtb1"> Location </td>
                                            <td width="8%" class="txtb1">  Cost </td>
											   <td width="8%" class="txtb1">Bed Room</td>
                                            <td width="8%" class="txtb1">Categ.</td>
                                            <td width="11%" class="txtb1"> Flat Floor </td>
                                            <td width="11%" class="txtb1">Desc</td>
                                            <td width="7%" class="txtb1">Date<br />
                                              (y/m/d)</td>
                                            <td width="5%" class="txtb1">&nbsp;</td>
											 <td width="5%" class="txtb1">&nbsp;</td>
                                          </tr>
	 ...
	 <!--<input type="checkbox" name="subdelchk" id="subdelchk" <?php if( $row['enable']==1) {?> checked <?php }?> onClick="return check();" />-->	 </td>
                                            ...
                                            <td class="txt-tb1"><a href="euro_estae.php?mode=DEL&Id=<?php print $row['id']; ?>"><img src="layoyt_butt_white_delete.gif" onClick="return del()" alt="DElET" border="0" width="18" height="22" /></a></td>
                                          </tr>
